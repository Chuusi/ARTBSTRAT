...
const { addProduct, getProductById,getProductByIdNoParam, getAllProducts, getProductByName, updateProduct, deleteProduct} = require("../controllers/Product.controllers");
...
ProductRoutes.get("/getbyidnoparam", getProductByIdNoParam);
